...
def calculates_results_stats(results_dic):
    ...
    try:
        ...
        print("ZeroDivisionError on n_dog_img - Calculates % correct dogs")
    ...
    try:
        ...
        print("ZeroDivisionError on n_dog_img - Calculates % correct breed of dog")
